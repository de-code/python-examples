...
In this example we are using [smolagents](https://github.com/huggingface/smolagents) with code agent.
...
```console
$ uv run -m python_examples.ai.agents.smolagents.smolagents_code_agent.agent
...
