# Smolagents Custom Tool Function

In this example we are defining a custom tool via a function.
...
```console
$ uv run -m python_examples.ai.agents.smolagents.smolagents_custom_tool_function.agent
